        ...
        return (
            <div className="bookform">
                ...
                <div className="drop-down">
                            <select name="available" value={this.state.available}onChange={this.handleInputChange}>{
                ...
                <div className="drop-down">
                            <select name="ageRange" value={this.state.ageRange}onChange={this.handleInputChange}>{
